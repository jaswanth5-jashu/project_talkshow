...
from .views import (
    ...
    ContactView, EpisodeView, UpdateEpisodeView, NewEpisodeView, TalentView, NewTalentView,
...
urlpatterns = [
    ...
    path("episode/new/", NewEpisodeView.as_view()),
    path("episode/<int:pk>/", UpdateEpisodeView.as_view()),
    path("talent/", TalentView.as_view()),
    path("talent/new/", NewTalentView.as_view()),
